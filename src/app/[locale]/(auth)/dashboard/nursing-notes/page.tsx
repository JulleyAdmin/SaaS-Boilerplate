...
export default function NursingNotesPage() {
  ...
  const handleCreateNote = () => {
    ...
    console.log('Creating new nursing note:', newNote);
  ...
  const noteTypes = Array.from(new Set(nursingNotes.map(note => note.noteType)));
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div className="flex items-center space-x-3">
                      <Avatar>
                        <AvatarFallback>
                          <AvatarInitials name={note.patientName} />
                        </AvatarFallback>
                      </Avatar>
                      <div>
